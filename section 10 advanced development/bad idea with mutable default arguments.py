...
Take this function:
"""
#def create_account(name: str, holder: str, account_holders: list = []): #list[] is getting appended every time function is called!!!.
    #print(id(account_holders)) #to confirm that 2 times function is called in a1 and a2 id is the same
#workaround #2 is to use NONE
...
#to work around issue with list [] in function - don't create it in function , but use it in calling function
#a1 = create_account('checking', 'Rolf',[])#
